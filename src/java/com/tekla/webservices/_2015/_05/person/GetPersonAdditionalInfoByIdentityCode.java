...
@XmlRootElement(name = "GetPersonAdditionalInfoByIdentityCode")
public class GetPersonAdditionalInfoByIdentityCode {

    @XmlElementRef(name = "key", namespace = "http://tekla.com/webservices/2015/05/Person", type = JAXBElement.class, required = false)
    protected JAXBElement<String> key;
    @XmlElementRef(name = "identityCode", namespace = "http://tekla.com/webservices/2015/05/Person", type = JAXBElement.class, required = false)
