 ...
 */
public class XRoadMetaServiceInterceptor extends AbstractSoapInterceptor  {
	
	private static final Log logger = LogFactory.getLog(XRoadMetaServiceInterceptor.class);
	
	private static final String XROAD_PROTOCOL_VERSION = "4.0";
	private static final String SUBSYSTEM_CODE = "";
	private static final String SERVICE_CODE = "allowedMethods";
	...
	public XRoadMetaServiceInterceptor(Map<ApiUserSetting, String> xroadConfigs) {
		super(Phase.WRITE);
	...
	private List<JAXBElement<?>> createXRoadHeaders() {
		...
		service.setSubsystemCode(SUBSYSTEM_CODE);
