...
public class Custodian {
    ...
    @XmlElementRef(name = "DecisionDate", namespace = "http://schemas.datacontract.org/2004/07/Tekla.GIS.WebService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> decisionDate;
     ...
     *     
     */
    public JAXBElement<String> getDecisionDate() {
        return decisionDate;
    }
     ...
     *     
     */
    public void setDecisionDate(JAXBElement<String> value) {
